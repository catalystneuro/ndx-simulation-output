...
# -*- coding: utf-8 -*-
#
# ndx-simulation-output documentation build configuration file, created by
# sphinx-quickstart on Thu Jun 13 15:28:51 2019.
#
...
htmlhelp_basename = 'ndx-simulation-outputdoc'
...
latex_documents = [
    (master_doc, 'ndx-simulation-output.tex', 'ndx-simulation-output Documentation',
     'Ben Dichter', 'manual'),
]
...
man_pages = [
    (master_doc, 'ndx-simulation-output', 'ndx-simulation-output Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ndx-simulation-output', 'ndx-simulation-output Documentation',
     author, 'ndx-simulation-output', 'One line description of project.',
     'Miscellaneous'),
]
